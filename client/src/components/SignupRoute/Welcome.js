...
export default class Welcome extends Component {
  ...
  componentDidUnMount() {
    document.getElementsByTagName("body").style.cssText =
          ...
          <div className="products">
            ...
            >
              ...
              <p className="description">
                Marglas makes you more happy, productive, creative, and capable
                of living, working, and loving a fulfilled life.
              </p>
            </div>
            <div className="product" product-id="2" product-color="#29336E">
              <div className="thumbnail">
                <img src="/img/blue.png" style={{ width: "30vw" }} />
              </div>
              <h1 className="title">The HERO Resources</h1>
              <p className="description">
                This app is based on qualitative research results related to
                psychological capital. With Marglas you strengthen your HERO
                resources - hope, efficiency, resilience & optimism - on a daily
                basis.
              </p>
            </div>
            <div className="product" product-id="3" product-color="#DE6322">
              <div className="thumbnail">
                <img src="/img/orange2.png" />
              </div>
              <h1 className="title">Answer & Shine</h1>
              <p className="description">
                Everyday, you will answer a question which lets you remember the
                little, positive things in life. Your answer is stored in your
                marglas. Every time, you are in need of some motivation or
                positive thoughts the marglas will pop up & spread the
                positivity.
              </p>
            </div>
            ...
            <div className="product" product-id="5" product-color="#BEDBF3">
              ...
              <p className="description">
                Start the journey to a more happy, productive & creative life!
              </p>
              <p>
                <Link className="getStarted" to="/home" component={Home}>
                  Start filling your marglas!
                </Link>
              </p>
            </div>
          </div>
